...
export interface H264MP4Encoder {
    ...
    initialize(): void;
    initializeAudio(sampleRate: number): void;
    /** Add a frame in YUV format (expected size: width * height * 3 / 2). */
    addFrameYuv(buffer: ArrayBuffer | Uint8Array | Uint8ClampedArray | Int8Array | string, duration: number): void;
    /**
     ...
     */
    addFrameRgba(buffer: ArrayBuffer | Uint8Array | Uint8ClampedArray | Int8Array | string, duration: number): void;
    addAudio(buffer: ArrayBuffer | Uint8Array | Uint8ClampedArray | Int8Array | string, duration: number): void;
...
export declare const createH264MP4Encoder: () => Promise<H264MP4Encoder>;
